# Generated by Django 4.1.3 on 2022-11-13 07:30
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userType', models.CharField(choices=[('DH', 'Department Head'), ('Person-in-charge', 'Person-in-charge'), ('R', 'Registrar'), ('STDNT', 'Student')], max_length=255, null=True, verbose_name='userType')),
                ...
                ('addStatus', models.CharField(blank=True, max_length=255, null=True)),
                ('dropStatus', models.CharField(blank=True, max_length=255, null=True)),
                ('transferStatus', models.CharField(blank=True, max_length=255, null=True)),
