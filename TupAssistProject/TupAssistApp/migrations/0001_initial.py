    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section', models.CharField(blank=True, choices=[('1A', '1A'), ('2A', '2A'), ('3A', '3A'), ('4A', '4A'), ('1B', '1B'), ('2B', '2B'), ('3B', '3B'), ('4B', '4B')], max_length=255, null=True)),
                ('userType', models.CharField(choices=[('Student', 'Student'), ('Department Head', 'Department Head'), ('Person-in-charge', 'Person-in-charge')], max_length=255, null=True, verbose_name='userType')),
