    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('yrandsec', models.CharField(blank=True, choices=[('STDNT', 'Student'), ('DH', 'Department Head'), ('PIC', 'Person-in-charge')], max_length=255, null=True)),
                ...
                ('department', models.CharField(choices=[('DOIT', 'Department of Industrial Technology'), ('DOIE', 'Department of Industial Education'), ('DOE', 'Department of Engineering')], max_length=255, verbose_name='department')),
