    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course', models.CharField(blank=True, choices=[('BET-ET', 'Electrical Technology'), ('BET-ESET', 'Electronics Technology'), ('BET-COET', 'Computer Engineering Technology '), ('BET-CT', 'Civil Technology'), ('BET-MT', 'Mechanical Technology'), ('BET-AT', 'Automotive Technology'), ('BET-PPT', 'Power Plant Technology'), ('BSCE', 'Civil Engineering'), ('BSEE', 'Electrical Engineering'), ('BSECE', 'Electronics Engineering'), ('BSME', 'Mechanical Engineering'), ('BSIE-ICT', 'Information and Communication Technology')], max_length=255, null=True)),
                ...
                ('userType', models.CharField(choices=[('DH', 'Department Head'), ('PIC', 'Person-in-charge'), ('R', 'Registrar'), ('STDNT', 'Student')], default='STDNT', max_length=255, verbose_name='userType')),
                ('department', models.CharField(choices=[('Department of Industrial Technology', 'Department of Industrial Technology'), ('Department of Industial Education', 'Department of Industial Education'), ('Department of Engineering', 'Department of Engineering')], max_length=255, null=True, verbose_name='department')),
