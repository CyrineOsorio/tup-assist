...
class AddingReq(models.Model):
    ...
    section = models.CharField(max_length=255, null=True, blank=True, default='-')
    sched = models.CharField(max_length=255, null=True, blank=True, default='-')
    req_date =  models.DateTimeField(null=True, blank=True, default='-')
    pic_is_approve = models.CharField(max_length=255, null=True, blank=True, default='-')
    pic_remark = models.CharField(max_length=255, null=True, blank=True, default='-')
    pic_name = models.CharField(max_length=255, null=True, blank=True, default='-')
    pic_date = models.DateTimeField(null=True, blank=True, default='-')
    ...
    head_date = models.DateTimeField(null=True, blank=True, default='-')
    admin_approve = models.CharField(max_length=255, null=True, blank=True, default='-')
    admin_name = models.CharField(max_length=255, null=True, blank=True, default='-')
    admin_date = models.DateTimeField(null=True, blank=True, default='-')
    reg_action = models.CharField(max_length=255, null=True, blank=True, default='-')
    enroll_by = models.CharField(max_length=255, null=True, blank=True, default='-')
...
class DroppingReq(models.Model):
    ...
    admin_date = models.DateTimeField(null=True, blank=True, default='-')
    reg_action = models.CharField(max_length=255, null=True, blank=True, default='-')
    enlist_by = models.CharField(max_length=255, null=True, blank=True, default='-')
    reg_date = models.DateTimeField(null=True, blank=True, default='-')
